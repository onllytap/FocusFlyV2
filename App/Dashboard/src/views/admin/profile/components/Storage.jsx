    ...
    <Card extra={"w-full h-full p-4"}>
      ...
      <div className="flex flex-col">
        <div className="flex justify-between">
          <p className="text-sm font-medium text-gray-600">127 habitudes</p>
          <p className="text-sm font-medium text-gray-600">500 habitudes</p>
        </div>
        <div className="mt-2 flex h-3 w-full items-center rounded-full bg-lightPrimary dark:!bg-navy-700">
          <span className="h-full w-1/4 rounded-full bg-brand-500 dark:!bg-white" />
        </div>
      </div>
    </Card>
  );
